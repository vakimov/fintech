# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-01 09:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sent_at', models.DateTimeField(blank=True, default=None, null=True, verbose_name='Дата и время отправки')),
                ('status', models.CharField(choices=[('NEW', 'новая'), ('SENT', 'отправленная'), ('RECEIVED', 'принятая')], default='NEW', max_length=10, verbose_name='Статус')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='application',
            unique_together=set([('customer_profile', 'offer')]),
        ),
    ]
